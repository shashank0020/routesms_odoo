...
class report_print_pettycash(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_print_pettycash, self).__init__(cr, uid, name, context)
        self.number_lines = 0
        self.number_add = 0
...
class report_cheque(osv.AbstractModel):
    _name = 'report.routesms.report_pettycash'
    _inherit = 'report.abstract_report'
    _template = 'routesms.report_pettycash'
    _wrapped_report_class = report_print_pettycash
