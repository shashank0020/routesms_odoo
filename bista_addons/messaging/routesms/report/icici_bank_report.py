...
class report_print_bank_icici(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_print_bank_icici, self).__init__(cr, uid, name, context)
        self.number_lines = 0
        self.number_add = 0
...
class report_bank_icici(osv.AbstractModel):
    _name = 'report.routesms.report_bank_icici'
    _inherit = 'report.abstract_report'
    _template = 'routesms.report_bank_icici'
    _wrapped_report_class = report_print_bank_icici
